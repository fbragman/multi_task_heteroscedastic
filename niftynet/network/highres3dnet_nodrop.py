...
class HighRes3DNet_NoDrop(BaseNet):
    """
    ...
    def __init__(self,
        ...
        self.layers = [
            ...
            {'name': 'res_1', 'n_features': 32, 'kernels': (3, 3), 'repeat': 2},
            {'name': 'res_2', 'n_features': 64, 'kernels': (3, 3), 'repeat': 2},
            {'name': 'res_3', 'n_features': 128, 'kernels': (3, 3), 'repeat': 2},
            {'name': 'conv_1', 'n_features': 1024, 'kernel_size': 3},
