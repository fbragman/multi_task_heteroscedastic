...
class MTHighRes3DNet(BaseNet):
    ...
    def __init__(self,
        ...
        self.layers = [
            ...
            {'name': 'task_1_fc_3', 'n_features': 256, 'kernel_size': 1},
            {'name': 'task_1_fc_4', 'n_features': 256, 'kernel_size': 1},

            {'name': 'task_2_fc_1', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_fc_2', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_fc_3', 'n_features': 256, 'kernel_size': 1},
            {'name': 'task_2_fc_4', 'n_features': 256, 'kernel_size': 1},
    ...
    def layer_op(self, images, is_training, layer_id=-1):
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task_1 = fc_layer(flow, is_training, keep_prob=self.dropout_rep)
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task_1 = fc_layer(flow_task_1, is_training, keep_prob=self.dropout_rep)
        layer_instances.append((fc_layer, flow_task_1))
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task_2 = fc_layer(flow, is_training, keep_prob=self.dropout_rep)
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task_2 = fc_layer(flow_task_2, is_training, keep_prob=self.dropout_rep)
        layer_instances.append((fc_layer, flow_task_2))
