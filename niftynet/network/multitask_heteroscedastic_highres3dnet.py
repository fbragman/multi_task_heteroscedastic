...
class MTHeteroHighRes3DNet(BaseNet):
    ...
    def __init__(self,
        ...
        self.layers = [
            ...
            {'name': 'conv_1', 'n_features': 256, 'kernel_size': 1},

            {'name': 'task_1_mean_fc_1', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_1_mean_fc_2', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_1_mean_fc_3', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_1_mean_fc_4', 'n_features': 256, 'kernel_size': 3},

            {'name': 'task_1_noise_fc_1', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_1_noise_fc_2', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_1_noise_fc_3', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_1_noise_fc_4', 'n_features': 256, 'kernel_size': 3},

            {'name': 'task_2_mean_fc_1', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_mean_fc_2', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_mean_fc_3', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_mean_fc_4', 'n_features': 256, 'kernel_size': 3},

            {'name': 'task_2_noise_fc_1', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_noise_fc_2', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_noise_fc_3', 'n_features': 256, 'kernel_size': 3},
            {'name': 'task_2_noise_fc_4', 'n_features': 256, 'kernel_size': 3},
