...
class MTHeteroHighRes3DNet(BaseNet):
    ...
    def __init__(self,
        ...
        self.layers = [
            {'name': 'conv_0', 'n_features': 32, 'kernel_size': 3},
            {'name': 'res_1', 'n_features': 32, 'kernels': (3, 3), 'repeat': 3},
            {'name': 'res_2', 'n_features': 64, 'kernels': (3, 3), 'repeat': 3},
            {'name': 'res_3', 'n_features': 128, 'kernels': (3, 3), 'repeat': 3},
            {'name': 'conv_1', 'n_features': 128, 'kernel_size': 1},

            {'name': 'task_1_mean_fc_1', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_1_mean_fc_2', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_1_mean_fc_3', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_1_mean_fc_4', 'n_features': 128, 'kernel_size': 3},

            {'name': 'task_1_noise_fc_1', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_1_noise_fc_2', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_1_noise_fc_3', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_1_noise_fc_4', 'n_features': 128, 'kernel_size': 3},

            {'name': 'task_2_mean_fc_1', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_2_mean_fc_2', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_2_mean_fc_3', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_2_mean_fc_4', 'n_features': 128, 'kernel_size': 3},

            {'name': 'task_2_noise_fc_1', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_2_noise_fc_2', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_2_noise_fc_3', 'n_features': 128, 'kernel_size': 3},
            {'name': 'task_2_noise_fc_4', 'n_features': 128, 'kernel_size': 3},
