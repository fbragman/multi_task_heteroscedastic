...
class MTHeteroHighRes3DNet(BaseNet):
    ...
    #               e.g.                        --- task 1  ---> prediction / noise
    #                    representation network                      ---> combined loss
    #                                           --- task 2  ---> prediction / noise
    def __init__(self,
                 num_classes,
                 dropout_rep,
                 w_initializer=None,
    ...
    def layer_op(self, images, is_training, layer_id=-1):
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task1_1 = fc_layer(flow, is_training)
        layer_instances.append((fc_layer, flow_task1_1))
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task1_2 = fc_layer(flow_task1_1, is_training)
        layer_instances.append((fc_layer, flow_task1_2))
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task2_1 = fc_layer(flow, is_training)
        layer_instances.append((fc_layer, flow_task2_1))
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task2_2 = fc_layer(flow_task2_1, is_training)
        layer_instances.append((fc_layer, flow_task2_2))
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task1_mean_output = fc_layer(flow_task1_2, is_training)
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task1_noise_output = fc_layer(flow_task1_2, is_training)
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task2_mean_output = fc_layer(flow_task2_2, is_training)
        ...
        fc_layer = ConvolutionalLayer(
            ...
            w_regularizer=self.regularizers['w'],
            name=params['name'])
        flow_task2_noise_output = fc_layer(flow_task2_2, is_training)
